        ...
        <NavbarBs style={{ minHeight: "70px" }} sticky="top" className="bg-white shadow-sm mb-3">
            <Container className="d-flex justify-content-between">
                <Nav className="justify-content-start">
                    ...
                    <Nav.Link to="/NotFound" as={NavLink}>
                        NotFound
                    </Nav.Link>
                </Nav>
                {cartQuantitiy > 0 && (
                    <Button onClick={openCart} style={{ width: "3rem", height: "3rem", position: "relative" }} variant="outline-primary" className="rounded-circle">
                        ...
                        <div className="rounded-circle bg-danger d-flex justify-content-center align-items-center" style={{ color: "white", width: "1.5rem", height: "1.5rem", position: "absolute", bottom: 0, right: 0, transform: "translate(25%,25%)" }}>{cartQuantitiy}</div>
                    </Button>
                )}
